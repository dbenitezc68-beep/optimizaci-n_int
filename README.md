...
- **"Requiere tu atención"** (Resumen): motor que consolida eventos de todos los módulos en una lista priorizada — incidencias abiertas, suscripciones impagadas, facturas vencidas, tareas vencidas o que vencen hoy, renovaciones próximas, cobros manuales sin llegar, procesos retrasados/pausados/inactivos, leads sin movimiento y clientes activos sin seguimiento. Umbrales en `src/lib/attention.ts`.
