...
|---|---|---|---|---|
| FDI medio de la empresa | Cuánto depende el conjunto de procesos documentados del fundador | Media de puntuación de todos los procesos en `fdi-registro.md` (0=automatizado, 3=exclusivo del fundador) | `00-metodologia.md` / Fase 2 | **1,9 / 3** (14 procesos registrados, ver `fdi-registro.md` — fuente de verdad, este valor se sincroniza desde allí) |
