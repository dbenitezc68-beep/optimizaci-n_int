...
| Contrato mínimo bloqueado por 2 campos en blanco (identificación fiscal de INTEREMPREX, duración de empaquetado de Motor B), sin fecha límite autoimpuesta. **Verificación urgente sin resolver en este repositorio: no hay evidencia de si "identificación fiscal pendiente" significa solo "el dato no está escrito en el contrato" o significa "INTEREMPREX no está dado de alta como autónomo/sociedad todavía" — son dos bloqueantes de naturaleza completamente distinta (documental vs. capacidad legal real de facturar), y el segundo precedería a este mismo contrato, no solo a completarlo. No se afirma cuál es la situación real: es una disyuntiva que el fundador debe verificar antes de dar por buena cualquier otra corrección de este documento.** | Alta (bloquea firmar con cualquier cliente nuevo) | Muy baja (horas de decisión del fundador, no trabajo de fase) | Alta (tarifa de lanzamiento cierra 2026-09-30 o al 3er cliente; ya hay 2 pilotos) | Alta (bloquea en cascada Pago, Inicio del proyecto y activación de Motor B) | Alta | `07-customer-journey.md` (hallazgo de la auditoría adversarial, Etapa 7) |
