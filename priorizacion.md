...
| R9 — Exposición legal activa (scraping de `leadfinder`, datos de cliente en el CRM) | Alta | Media | Alta (exposición ya activa hoy) | Alta (bloquea escalar prospección con confianza) | Alta | `03-modelo-negocio.md`, `auditoria-preventiva-leadfinder.md` — **desarrollado en detalle en `06-legal-cumplimiento.md` como L1-L11** |
...
| ~~Contrato mínimo bloqueado por 2 campos en blanco~~ — **actualizado 2026-07-15**: la duración de empaquetado de Motor B ya no bloquea (ADR-002, `decisiones-adr.md`, 6 meses). Queda 1 campo: **identificación fiscal de INTEREMPREX. Disyuntiva resuelta por el fundador: no es un problema documental, es de capacidad legal de facturar — INTEREMPREX no está dado de alta todavía.** Plan confirmado: (1) inscripción inmediata como demandante de empleo en el SEXPE, requisito previo para la Tarifa Cero del Programa III de Extremadura; (2) alta como autónomo (modelo 036 + RETA, casilla de cuota reducida) en septiembre de 2026, cuando existan clientes listos para contratar. **No ejecutado todavía — planificado.** Detalle en `alta-autonomo.md`. El NIF del contrato queda como campo a rellenar en el momento del alta, no antes. | Alta (bloquea firmar con cualquier cliente nuevo) | Baja (trámites administrativos ya planificados, no decisiones por tomar) | Alta (el alta planificada para septiembre de 2026 coincide con el cierre de la tarifa de lanzamiento, 2026-09-30; ya hay 2 pilotos) | Alta (bloquea en cascada Pago, Inicio del proyecto y activación de Motor B) | Alta | `07-customer-journey.md` (hallazgo de la auditoría adversarial, Etapa 7), `alta-autonomo.md` |
...
| Tensión estructural de pricing: posicionamiento premium/alto margen vs. precios de Motor B incompatibles con el FDI actual | Alta (a escala; hoy no bloquea nada porque el volumen es bajo) | Media-alta (resolverla exige repensar precios de Motor B o invertir en reducir el FDI de las etapas del Customer Journey, no un ajuste rápido) | Baja hoy (tope de 3 clientes en tarifa de lanzamiento, sin presión de volumen todavía) | Alta (cruza Fase 7 — Sistema comercial, Fase 14 — Finanzas, y la decisión ya identificada en `07-customer-journey.md` sobre un segundo usuario del CRM) | Media-alta (crece con cada cliente nuevo de Motor B, no es un riesgo que se difumine solo) | `01-posicionamiento.md`, `02-principios-fundacionales.md`, `03-modelo-negocio.md`, `05-catalogo-servicios.md` |
...
**Qué documentos deben revisarse si este cambia**: los documentos de origen de cada fila (`03-modelo-negocio.md`, `flywheel-comercial.md`, `capacidades-core.md`, `05-catalogo-servicios.md`, `auditoria-preventiva-leadfinder.md`, `duplicidad-paneles-gestion.md`, `01-posicionamiento.md`, `02-principios-fundacionales.md`, `06-legal-cumplimiento.md`, `07-customer-journey.md`, `decisiones-adr.md`, `alta-autonomo.md`) si cambia el estado del elemento correspondiente. Actualizado 2026-07-12: añadida la fila de tensión estructural de pricing (prioridad alta) y elevada la disyuntiva fiscal del contrato mínimo a verificación urgente sin resolver. Actualizado 2026-07-15: disyuntiva fiscal resuelta por el fundador (bloqueante de capacidad legal, no documental) y duración de Motor B resuelta vía ADR-002 — ver la fila actualizada arriba y `alta-autonomo.md`.
