...
| 5 | Catálogo | [`05-catalogo-servicios.md`](./05-catalogo-servicios.md) — arquitectura comercial completa, apoyada en `capacidades-core.md` y `flywheel-comercial.md` | Arquitectura de la oferta, Capacidades Core | Pendiente de aprobación definitiva |
